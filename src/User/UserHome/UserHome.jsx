        ...
        <Row>
          <Col lg={{span:10,offset:1}} md={12}>
            <div className='sec_provider mt-5'>
              ...
              <Link to="/usercreditreport"><FaArrowRight style={{ color: "#4b7a7c", fontSize: "22px", marginRight: "22px" }} /></Link>
            </div>
          </Col>
          <Col lg={{span:10,offset:1}} md={12}>
          ...
          <Row>
            ...
            <Col lg={{span:4,offset:1}} md={6} className="mt-5">
              <div className='myaccount'>
                <h1>My Account</h1>
                <Link to="/myaccount"><FaArrowRight style={{ color: "#4b7a7c", fontSize: "22px", marginRight: "22px", marginLeft: "12px" }} /></Link>
              </div>
