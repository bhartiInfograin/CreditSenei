...
export default function CreditScore() {
    return (
        <>
            <section  style={{background:"#CEF9E7" }} className='mt-2 pb-5'>
            <Container  >
                <Row>
                    <Col lg={12}  md={12} >
                ...
                <Row  >
                    <Col lg={4}  md={4} >
                        <Card className="creditscore_card" style={{background:"#57D6A1"}} >
                            <Card.Body className='cardcontanier'>
                                <Card.Title> <div className='credirscore_card_count'>1</div> </Card.Title>
                                <Card.Title style={{color:"#004C4D"}}>Lorem ipsum dolor sit amet consectetur </Card.Title>
